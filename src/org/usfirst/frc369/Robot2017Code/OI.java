...
//	public double rightSpeed;
   ...
   public static enum DriveModes {
    ...
    DriveModes mode = DriveModes.normal;
    
    public double getSpeedFromL2R2() {
    	return (-1*normalizeTriggers(getR2()) + ((normalizeTriggers(getL2()))));
    	
    }
    
    public double getLeftSpeed(){
    	if(mode == DriveModes.game)
    		return getSpeedFromL2R2();
    	else
    		return getleftStick();
    }
    ...
    public double getL2(){
    	return ps4_Controller.getRawAxis(3);
    }
    public double normalizeTriggers(double value) {
    	return ((value/2) + 0.5);
    }
    public double getR2(){
    	return ps4_Controller.getRawAxis(4);
    }
