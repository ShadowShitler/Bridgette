...
//    private UsbCamera camera1 = new UsbCamera();
//    private UsbCamera camera2 = new UsbCamera();
//    private VideoSink server = new VideoSink();
...
//        CameraServer.getInstance().addServer("climb", 1);
//        CameraServer.getInstance().addAxisCamera("roboRIO-369-FRC.local");
//        
        //CameraServer.getInstance().addServer("front", 0);
